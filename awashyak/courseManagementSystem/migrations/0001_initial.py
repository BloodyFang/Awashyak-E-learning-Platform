...
import courseManagementSystem.orderFields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coursePic', models.ImageField(blank=True, default='t.png', upload_to='course_pics/')),
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('overview', models.TextField()),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses_crerated', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', courseManagementSystem.orderFields.OrderField(blank=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='courseManagementSystem.course')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='courseManagementSystem.subject'),
        ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='courseManagementSystem.module')),
            ],
            options={
                'ordering': ['order'],
            },
